...
/// why the first map (e.g. a ride-request or active-ride screen) shows
/// blank/gray tiles for a second or two before it renders. By briefly
/// creating a tiny, off-screen, invisible map while the driver is sitting on
/// the idle home screen, that init happens up front, so the real maps render
